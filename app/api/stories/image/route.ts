...
export async function POST(req:Request){
 ...
 try{
  ...
  const STYLE_PRESERVE_INSTRUCTION="Maintain the exact same rendering style, warm peach pastel lighting, and soft clay/plush texture as the reference image. Keep the character's face, hair, clothing texture, and overall color palette identical. Only change background, pose, and expression according to the story.";
